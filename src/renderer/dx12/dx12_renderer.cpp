...
cg::renderer::dx12_renderer::create_vertex_buffer_view(
	const Microsoft::WRL::ComPtr<ID3D12Resource>& vertex_buffer,
...
cg::renderer::dx12_renderer::create_index_buffer_view(
	const Microsoft::WRL::ComPtr<ID3D12Resource>& index_buffer,
...
void cg::renderer::descriptor_heap::create_heap(
    ...
    // TODO Lab: 3.04 Implement `create_heap`, `get_cpu_descriptor_handle`, `get_gpu_descriptor_handle`, and `get`
